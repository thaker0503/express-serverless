...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    tasks<T extends User$tasksArgs= {}>(args?: Subset<T, User$tasksArgs>): Prisma.PrismaPromise<Array<TaskGetPayload<T>>| Null>;
  ...
  export type TaskGetPayload<S extends boolean | null | undefined | TaskArgs> =
    ...
    : S extends { select: any } & (TaskArgs | TaskFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'author' ? UserGetPayload<S['select'][P]> | null :  P extends keyof Task ? Task[P] : never
  } 
      : Task
   ...
   * Task aggregateRaw
   */
  export type TaskAggregateRawArgs = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type TaskCreateNestedManyWithoutAuthorInput = {
    create?: XOR<Enumerable<TaskCreateWithoutAuthorInput>, Enumerable<TaskUncheckedCreateWithoutAuthorInput>>
    connectOrCreate?: Enumerable<TaskCreateOrConnectWithoutAuthorInput>
  ...
  export type TaskUpdateManyWithoutAuthorNestedInput = {
    create?: XOR<Enumerable<TaskCreateWithoutAuthorInput>, Enumerable<TaskUncheckedCreateWithoutAuthorInput>>
    connectOrCreate?: Enumerable<TaskCreateOrConnectWithoutAuthorInput>
    upsert?: Enumerable<TaskUpsertWithWhereUniqueWithoutAuthorInput>
    createMany?: TaskCreateManyAuthorInputEnvelope
    set?: Enumerable<TaskWhereUniqueInput>
    disconnect?: Enumerable<TaskWhereUniqueInput>
    delete?: Enumerable<TaskWhereUniqueInput>
    connect?: Enumerable<TaskWhereUniqueInput>
    update?: Enumerable<TaskUpdateWithWhereUniqueWithoutAuthorInput>
    updateMany?: Enumerable<TaskUpdateManyWithWhereWithoutAuthorInput>
  ...
  export type TaskCreateManyAuthorInputEnvelope = {
    data: Enumerable<TaskCreateManyAuthorInput>
  }
